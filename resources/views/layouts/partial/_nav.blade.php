      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="{{ actives('root_path')}}"><a href="{{ route('root_path') }}">Home</a></li>
            <li class="{{actives('about_path')}}"><a href="{{route('about_path')}}">About</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="https://Laracast.com">Laracast.com</a></li>
                <li><a href="https://Laraveljobs.com">Laraveljobs</a></li>
